...
- [Задания для разработки алгоритма на 08.09.2022](#задания-для-разработки-алгоритма-на-08092022)
  ...
  - [Практическая работа 2: Лабораторная работа №3. Исследование особенностей разработки разветвляющихся алгоритмов на C#](#практическая-работа-2-лабораторная-работа-3-исследование-особенностей-разработки-разветвляющихся-алгоритмов-на-c)
    ...
    - [2 Литература](#2-литература)
    - [3 Подготовка к работе](#3-подготовка-к-работе)
    - [4 Основное оборудование](#4-основное-оборудование)
    - [5 Задание](#5-задание)
    - [6 Порядок выполнения работы](#6-порядок-выполнения-работы)
    - [7 Содержание отчета](#7-содержание-отчета)
...
#### 1 Цель работы
1.1 Изучить процесс разработки разветвляющихся алгоритмов на языке C#;

1.2 Закрепить навык разработки приложений на языке C#.

#### 2 Литература
2.1 Фленов, М.Е. Библия C#. 2 изд. – Санкт-Петербург: БХВ-Петербург 2011. – с.64-68.
...
#### 5 Задание
5.1 Написать программу, вычисляющую значение функции $у$:
- если $x < -5$, то $y(x)= а\cdot х2$;
- если $-5 ≤ x < 1$, то $y(x)= a\cdot |x|$;
- если $x ≥ 1$, то $y(x)= 1/(a-x)$.

Числа $a$ и $x$ вводятся пользователем. Результат округлять до трех знаков после
запятой.

5.2 Написать программу, определяющую по введенному пользователем году и
номеру месяца:
- является ли введенный пользователем год високосным;
- сколько дней в месяце.

При выполнении учитывать, что год является високосным, если он кратен 4 и не
кратен 100 или если он кратен 400.

5.3 Написать программу, находящую площадь треугольника, если его можно построить по введенным пользователем трем числам (длинам сторон). Определить вид треугольника.
...
Результат округлять до двух знаков после запятой. Если треугольник построить
нельзя, сообщить об этом пользователю.

5.4 Написать приложение «Конвертер валют». Курс валют (доллары, евро, йены) задать программно, исходную сумму в рублях и требуемую валюту указывает пользователь. На выходе — сумма в валюте, округленная до двух знаков после запятой.
...
В магазине действует система скидок: 3% предоставляется, если сумма покупки
больше 500 рублей, 5% – если сумма больше 1000 рублей.

#### 6 Порядок выполнения работы
6.1 Запустить MSVisual Studio и создать консольное приложение C# (Console Application).

6.2 Выполнить все задания из п.5 в одном решении LR_03 (для каждого задания
создавать внутри решения свой проект Task_#, где вместо # указывать номер
задания).

При разработке считать, что пользователь ввелданные требуемого типа, остальные возможные ошибки обрабатывать.
...
7.3 Код разработанных приложений
...
8.1 Какие виды условных операторов имеются в C#?

8.2 Какова может быть вложенность операторов ветвления?

8.3 Каков формат тернарного оператора?

8.4 Является ли обязательной часть else условного оператора?

8.5 Как указать в операторе выбора выполнение одних и тех же действий для
различных параметров, не дублируя код?

8.6 Какие логические операторы могут применяться при составлении условий?
